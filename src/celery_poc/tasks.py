...
def process_data(self, data_size):
    ...
    try:
        ...
        result = {"status": "completed", "processed": processed, "total": data_size}
        ...
        # Perform cleanup
        return {"status": "timeout", "processed": processed, "total": data_size}
...
def download_file(self, url):
    ...
    self.update_state(state="DOWNLOADING", meta={"url": url, "progress": 0})

    # Simulate download progress
    for progress in range(0, 101, 20):
        time.sleep(0.5)
        self.update_state(state="DOWNLOADING", meta={"url": url, "progress": progress})
